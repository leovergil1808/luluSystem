    ...
    <div class="wrap clearfix">
        ...
        <div id="content" class="fl-right">
            <div class="section" id="title-page">
                <div class="clearfix">
                    <h3 id="index" class="fl-left">Danh sách danh mục bài viết</h3>
                                        ...
                                        <tr>
                                            ...
                                            <td class="clearfix">
                                                <div class="tb-title fl-left">
                                                    <a href="" title=""><?php echo $post_cat['cat_title']; ?></a>
                                                </div> 
                                                <ul class="list-operation fl-right">

                                                    <li><a href="<?php echo $post_cat['url_update']; ?>" title="Sửa" class="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></li>
                                                    <li><a href="<?php echo $post_cat['url_delete']; ?>" title="Xóa" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                                </ul>
                                            </td>
                                            <td><span class="tbody-text">0</span></td>
                                            <td><span class="tbody-text"><?php echo $post_cat['creator']; ?></span></td>
                                            <td><span class="tbody-text"><?php echo time_format($post_cat['created_date']); ?></span></>
                                            <td><span class="tbody-text"><?php echo $post_cat['editor']; ?></span></td>
                                            <td><span class="tbody-text"><?php echo time_format($post_cat['update_date']); ?></span></td>
                                        </tr>
                                        <?php
                                    }
                                    ?>
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    ...
                    <?php echo get_pagging($num_page, $page, "?mod=posts&action=listPostCat"); ?>
                    </ul>
                </div>
            </div>
        </div>
