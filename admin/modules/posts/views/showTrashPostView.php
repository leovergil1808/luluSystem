    ...
    <div class="wrap clearfix">
        ...
        <div id="content" class="fl-right">
            <div class="section" id="title-page">
                <div class="clearfix">
                    <h3 id="index" class="fl-left">Danh sách bài viết rác</h3>
                ...
                <div class="section-detail">
                    ...
                    <form method="POST" action="" class="form-actions">
                        <div class="actions">
                            ...
                            <select name="actions">
                                <option value="0">Danh sác tác vụ</option>
                                <option value="1">Khôi phục</option>
                                <option value="2">Xoá bài viết</option>
                            </select>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($list_post as $item) {
                                            ...
                                            <tr>
                                                ...
                                                <td><!--<span class="tbody-text"><?php //echo $item['post_status'];      ?></span> -->
                                                    <a href="<?php echo $item['url_restore'] ?>">Khôi phục</a> -||- <a href="<?php echo $item['url_delete'] ?>" style="color : red;">Xoá bài</a>
                                                </td>
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    <?php echo get_pagging($num_page, $page, "?mod=posts&action=showTrashPost") ?>
                </div>
            </div>
        </div>
    </div>
