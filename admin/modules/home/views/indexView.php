        ...
        <div id="content" class="fl-right">           
            <div class="section" id="title-page">
                <div class="clearfix">
                    ...
                    <a href="?mod=pages&action=addPage" title="" id="add-new" class="fl-left">Thêm trang mới</a>
                </div>
            </div>            
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    <?php echo get_pagging($num_page, $page, "?mod=pages&action=index"); ?>
                </div>
            </div>
        </div>
    </div>
