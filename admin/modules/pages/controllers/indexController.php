    ...
    if (isset($_GET['sm_s']) && !empty($_GET['search_by']) && !empty($_GET['s'])) {
        ...
        if (isset($_POST['sm_action'])) {
            if (!empty($_POST['checkItem'])) {
                # Checkbox = 1 : Edit Item, Checkbox = 2 : Move Trash Item, Checkbox = 3 : Approve Item
                if ($_POST['actions'] == 1) {
...
function addPageAction() {
    ...
    global $error, $page_title, $slug, $page_content, $page_thumbnail, $page_desc;
