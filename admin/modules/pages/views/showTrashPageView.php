    ...
    <div class="wrap clearfix">
        ...
        <div id="content" class="fl-right">
            <div class="section" id="title-page">
                <div class="clearfix">
                    <h3 id="index" class="fl-left">Danh sách trang rác</h3>
                    ...
                    <form method="POST" action="" class="form-actions">
                        <div class="actions">
                            <select name="actions">
                                ...
                                <option value="1">Khôi phục trang</option>
                                <option value="2">Xoá trang</option>
                            </select>
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    <div class="section-detail clearfix">
                        <?php echo get_pagging($num_page, $page, "?mod=pages&action=showTrashPage"); ?>
                    </div>
                </div>
            </div>
        </div>
