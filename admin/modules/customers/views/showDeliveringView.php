    ...
    <div class="wrap clearfix">
        ...
        <div id="content" class="fl-right">
            <div class="section" id="title-page">
                <div class="clearfix">
                    <h3 id="index" class="fl-left">Danh sách đơn hàng đang chuyển</h3>
                </div>
            </div>
                    ...
                    <form method="POST" action="" class="form-actions">
                        <div class="actions">
                            ...
                            <select name="actions">
                                ...
                                <option value="2">1. Gỡ, tạm chỉnh sửa</option>
                                <option value="3">2. Kết thúc đơn hàng</option>
                            </select>
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    ...
                    <?php echo get_pagging($num_page, $page, "?mod=customers&action=showDelivering"); ?>
                </div>
            </div>
        </div>
    </div>
