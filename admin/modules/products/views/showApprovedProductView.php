    ...
    <div class="wrap clearfix">
        ...
        <div id="content" class="fl-right">
            <div class="section" id="title-page">
                <div class="clearfix">
                    <h3 id="index" class="fl-left">Danh sách sản phẩm đã duyệt</h3>
                                ...
                                <table class="table list-table-wp">
                                    <thead>
                                        <tr>
                                            ...
                                            <td><span class="thead-text">Người duyệt</span></td>
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    <?php echo get_pagging($num_page, $page, "?mod=products&action=showApprovedProduct"); ?>
                </div>
            </div>
        </div>
    </div>
