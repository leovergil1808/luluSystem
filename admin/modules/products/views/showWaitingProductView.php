    ...
    <div class="wrap clearfix">
        ...
        <div id="content" class="fl-right">
            <div class="section" id="title-page">
                <div class="clearfix">
                    <h3 id="index" class="fl-left">Danh sách sản phẩm chờ xét duyệt</h3>
                    ...
                    <form method="POST" action="" class="form-actions">
                        <div class="actions">
                            ...
                            <select name="actions">
                                ...
                                <option value="1">1. Duyệt sản phẩm</option>
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    <?php echo get_pagging($num_page, $page, "?mod=products&action=showWaitingProduct") ?>
                </div>
            </div>
        </div>
    </div>
