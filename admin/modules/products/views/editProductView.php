    ...
    <div class="wrap clearfix">
        ...
        <div id="content" class="fl-right">      
            <div class="section" id="title-page">
                <div class="clearfix">
                    <h3 id="index" class="fl-left">Chỉnh sửa sản phẩm</h3>
                </div>
            </div>
            <div class="section" id="detail-page">
                <div class="section-detail">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <input type="text" name="product_title" id="product-name" value="<?php echo $product['title']; ?>">
                        ...
                        <input type="text" name="product_code" id="product-code" value="<?php echo $product['code']; ?>" readOnly="readonly">
                        <p class="error"><?php echo form_error('product_code'); ?></p>

                        <label for="product_price">Giá sản phẩm</label>
                        <input type="number" name="product_price" id="price" value="<?php echo $product['price']; ?>">
                        <p class="error"><?php echo form_error('product_price'); ?></p>

                        <label for="product_price">Giá cũ</label>
                        <input type="number" name="old_price" id="price" value="<?php echo $product['old_price']; ?>">
                        <p class="error"><?php echo form_error('old_price'); ?></p>

                        <label for="product_content">Nội dung sản phẩm</label>
                        <textarea name="product_content" id="content" class="ckeditor"><?php echo $product['content']; ?></textarea>
                        <p class="error"><?php echo form_error('product_content'); ?></p>

                        <label for="product_description">Mô tả ngắn</label>
                        <textarea name="product_description" id="desc" class="ckeditor"><?php echo $product['description']; ?></textarea>
                        <p class="error"><?php echo form_error('product_description'); ?></p>

                        <label for="product_detail">Chi tiết sản phẩm</label>
                        <textarea name="product_detail" id="detail" class="ckeditor"><?php echo $product['detail']; ?></textarea>
                        ...
                        <div id="uploadFile">
                            ...
                            <img id="upload-image" src="<?php echo $product['thumbnail']; ?>">
                        </div>
                        ...
                        if (!empty($list_product_cat)) {
                            ?>
                            <select name="cat_id">
                                <option value="">-- Đổi danh mục --</option>
                                <?php
                        ...
                        <button type="submit" name="btn-submit" id="btn-submit">Chỉnh sửa sản phẩm</button>
                    </form>
                </div>
            </div>
        </div>
