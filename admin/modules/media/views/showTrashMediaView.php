    ...
    <div class="wrap clearfix">
        ...
        <div id="content" class="fl-right">
            <div class="section" id="title-page">
                <div class="clearfix">
                    <h3 id="index" class="fl-left">Danh sách media rác</h3>
                </div>
            </div>
                    ...
                    <form method="POST" action="" class="form-actions">
                        <div class="actions">
                            <select name="actions">
                                ...
                                <option value="1">Khôi phục mục chọn</option>
                                <option value="2">Xoá mục chọn</option>
                            </select>
                                            ...
                                            <tr>
                                                ...
                                                <td class="clearfix">
                                                    ...
                                                    <ul class="list-operation fl-right">
                                                        <li><a href="<?php echo $item['url_restore']; ?>" title="Sửa" class="edit"><i class="fa fa-reply" aria-hidden="true"></i></a></li>
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    ...
                    <?php echo get_pagging($num_page, $page, "?mod=media&action=showTrashMedia"); ?>
                </div>
            </div>
        </div>
    </div>
