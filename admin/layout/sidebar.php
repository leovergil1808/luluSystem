<div id="sidebar" class="fl-left">
    <ul id="sidebar-menu">
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                <!-- <li class="nav-item">
                    <a href="?mod=pages&controller=index&action=addPage" title="" class="nav-link">Thêm mới</a>
                </li> -->
                <li class="nav-item">
        ...
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                <!-- <li class="nav-item">
                    <a href="?mod=posts&controller=index&action=addPost" title="" class="nav-link">Thêm mới</a>
                </li> -->
                <li class="nav-item">
                    <a href="?mod=posts&action=index" title="" class="nav-link">Danh sách bài viết</a>
                </li>
                <li class="nav-item">
                    <a href="?mod=posts&action=listPostCat" title="" class="nav-link">Danh mục bài viết</a>
                </li>
            </ul>
        </li>
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                ...
                <li class="nav-item">
                    <a href="?mod=products&action=listProductCat" title="" class="nav-link">Danh mục sản phẩm</a>
                </li>
            </ul>
        </li>
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                ...
                <li class="nav-item">
                    <a href="?mod=customers&action=listCustomer" title="" class="nav-link">Danh sách khách hàng</a>
                </li>
            </ul>
        </li>
        <li class="nav-item">
