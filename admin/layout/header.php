                    ...
                    <div class="wp-inner clearfix">
                        ...
                        <ul id="main-menu" class="fl-left">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="?mod=posts&action=addPost" title="">Thêm mới</a> 
                                    </li>
                                    <li>
                                        <a href="?mod=posts&action=index" title="">Danh sách bài viết</a> 
                                    </li>
                                    <li>
                                        <a href="?mod=posts&action=listPostCat" title="">Danh mục bài viết</a> 
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li>
                                        <a href="?mod=products&action=listProductCat" title="">Danh mục sản phẩm</a> 
                                    </li>
                                </ul>
                            </li>
                            <li>
                        ...
                        <div id="dropdown-user" class="dropdown dropdown-extended fl-right">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="?mod=users&controller=index&action=index" title="Thông tin cá nhân">Thông tin tài khoản</a></li>
